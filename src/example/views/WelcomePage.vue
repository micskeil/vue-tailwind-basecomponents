<template>
  <MainLayout>
    <div>
      ...
      <ParagraphElement>
        Streamline your <b>Vue 3 Tailwind projects</b> with our powerful collection of
        basic elements. Our easy-to-use components come with predefined CSS layouts, so
        you can create beautiful web applications effortlessly.
      </ParagraphElement>
      <ParagraphElement>
      ...
      <ParagraphElement>
        It's generally best to import directly from packages when using components,
        composables, and directives. This ensures use of the latest code version, reduces
        potential conflicts with other libraries, keeps code clean, and makes it easier to
        read.
      </ParagraphElement>
      <ParagraphElement>
